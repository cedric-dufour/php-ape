 ...
 *
 * <P><B>SYNOPSIS:</B> This interface provisions the methods that allow to retrieve the data filter associated with the implementing object.</P>
 *
 * @package PHP_APE_Data
 * @subpackage Interfaces
 */
interface PHP_APE_Data_hasFilter
extends PHP_APE_Data_hasInterface
{
  ...
  /** Returns if this object's data filter has been defined
   *
   * @return boolean
   */
  public function hasFilter();

  /** Returns this object's data filter
   *
