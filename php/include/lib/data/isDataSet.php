...
/** Data set interface
 *
 * <P><B>SYNOPSIS:</B> This interface provisions the methods that allow to retrieve dataset-organized data (elements) from the implementing object.</P>
 *
 * @package PHP_APE_Data
 * @subpackage Interfaces
 */
interface PHP_APE_Data_isDataSet
extends PHP_APE_Data_hasInterface
{
   ...
   * @return boolean
   */
  public function isElement( $mKey );
   ...
   */
  public function getElement( $mKey );
   ...
   * @return PHP_APE_Data_Any
   */
  public function &useElement( $mKey );
