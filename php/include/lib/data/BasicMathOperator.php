...
/** Basic mathematical operators handling class
 *
 * @package PHP_APE_Data
 * @subpackage Classes
 */
class PHP_APE_Data_BasicMathOperator
extends PHP_APE_Data_Operator
{
  ...
  /** <SAMP>+</SAMP> (addition)
   * @var integer */
  const Addition = 0; // 0b........:....00..

  /** <SAMP>-</SAMP> (soustraction)
   * @var integer */
  const Soustraction = 4; // 0b........:....01..

  /** <SAMP>*</SAMP> (multiplication)
   * @var integer */
  const Multiplication = 8; // 0b........:....10..

  /** <SAMP>/</SAMP> (division)
   * @var integer */
  const Division = 12; // 0b........:....11..
